...
/*
	TODO(george): Convert all of these to platform-efficient versions
	and remove math.h
*/
...
#else
// TODO(georgy): Need to define these on GCC/LLVM?
...
#else
    // TODO(george): Actually port this to other compiler platforms!
    Amount &= 31;
