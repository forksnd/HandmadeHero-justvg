        ...
        if(Entity->Updatable)
        {
            ...
            switch(Entity->Type)
            {
                ...
                case EntityType_Familiar:
                {
                    ...
                    PushBitmap(RenderGroup, GetFirstBitmapID(TranState->Assets, Asset_Shadow), 0.25f, V3(0, 0, 0), V4(1, 1, 1, (0.5f*ShadowAlpha) + 0.2f*BobSin));
                    PushBitmap(RenderGroup, &HeroBitmaps->Hero, 0.5f, V3(0, 0, 0.5f*BobSin));
                } break;

                case EntityType_Monstar:
                {
                    PushBitmap(RenderGroup, GetFirstBitmapID(TranState->Assets, Asset_Shadow), 0.25f, V3(0, 0, 0), V4(1, 1, 1, ShadowAlpha));                  
